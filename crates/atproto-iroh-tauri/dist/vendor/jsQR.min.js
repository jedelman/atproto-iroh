// Vendored from https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.min.js
// jsQR 1.4.0, Apache-2.0 license — see jsQR-LICENSE.txt alongside this file.
// Pure-JS QR decoder, no build step, fits this repo's "plain HTML/JS/CSS,
// no bundler, no framework" reference-client rule (CLAUDE.md's Client
// section) while giving scan support without a native Tauri plugin — the
// only maintained one (tauri-plugin-barcode-scanner) requires Tauri 3.0
// alpha, incompatible with this app's stable Tauri 2 dependency.
/**
